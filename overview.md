...
- To install the latest release of MATLAB on the self-hosted runner, specify the **Install MATLAB** task in your pipeline. (The agent must include all the dependencies required to run MATLAB.)
