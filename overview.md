...
For example, author a pipeline that runs the tests in your private project by using the latest release of MATLAB inside a container on a self-hosted UNIX agent:
...
- To install the latest release of MATLAB, specify the **Install MATLAB** task in your pipeline.
